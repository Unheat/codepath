...
const EditCreator = () => {
  ...
  return (
    <div className="EditCreator text-center flex flex-col items-center">
      <h2>Edit Creator</h2>
      ...
      <form onSubmit={updateCreator}>
        ...
        <button
          type="submit"
          className="w-[914px] m-[10px] pl-[20px] ml-[100px] mr-[100px]"
        >
          Update Creator
        </button>
      </form>
      ...
      <button
        className="delete-btn text-[#FEFDFD] bg-[#C11010] w-[300px]"
