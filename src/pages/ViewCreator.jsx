...
const ViewCreator = () => {
    ...
    return (
        <div className="ViewCreator" style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '30px', marginBottom: '30px', flexWrap: 'wrap' }}>
                ...
                <div className="social-links" style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    ...
                    <p style={{ fontSize: '18px', color: '#ccc' }}>{creator.description}</p>
            ...
            <div className="action-buttons" style={{ display: 'flex', gap: '15px' }}>
                ...
                <Link to={`/edit/${creator.id}`}>
                    <button style={{ backgroundColor: '#4a90e2', color: 'white', padding: '10px 30px', border: 'none', borderRadius: '5px', cursor: 'pointer', fontWeight: 'bold' }}>
                        EDIT
                    </button>
                </Link>
                ...
                <button 
                    ...
                    style={{ backgroundColor: '#ff4a4a', color: 'white', padding: '10px 30px', border: 'none', borderRadius: '5px', cursor: 'pointer', fontWeight: 'bold' }}>
                    DELETE
                </button>
            </div>
        </div>
